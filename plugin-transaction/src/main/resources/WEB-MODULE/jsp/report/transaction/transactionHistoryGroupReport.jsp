...
<jsp:useBean id="ctx"
	type="org.unidal.cat.transaction.report.page.Context" scope="request" />
<jsp:useBean id="payload"
	type="org.unidal.cat.transaction.report.page.Payload" scope="request" />
<jsp:useBean id="model"
	type="org.unidal.cat.transaction.report.page.Model" scope="request" />
