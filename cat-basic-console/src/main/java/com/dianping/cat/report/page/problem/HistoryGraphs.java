...
import com.dainping.cat.consumer.core.dal.DailygraphEntity;
import com.dainping.cat.consumer.core.dal.Graph;
import com.dainping.cat.consumer.core.dal.GraphDao;
import com.dainping.cat.consumer.core.dal.GraphEntity;
...
public class HistoryGraphs {
	...
	private HistoryGraphItem buildFail(List<Map<String, double[]>> datas, Date start, long step, int size) {
