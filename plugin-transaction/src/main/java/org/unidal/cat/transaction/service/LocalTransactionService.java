...
import org.unidal.cat.transaction.model.entity.AllDuration;
import org.unidal.cat.transaction.model.entity.Duration;
import org.unidal.cat.transaction.model.entity.Range;
...
public class LocalTransactionService extends LocalModelService<TransactionReport> {
	...
	public static class TransactionReportFilter extends
	      org.unidal.cat.transaction.model.transform.DefaultXmlBuilder {
		...
		@Override
		public void visitMachine(org.unidal.cat.transaction.model.entity.Machine machine) {
